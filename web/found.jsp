        ...
        <section class="container my-5">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="fs-1">All Found Item</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane container active" id="item-pills-tabs-0">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getCategory_name() == 'Found'}">
                ...
                <div class="tab-pane container" id="item-pills-tabs-1">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Điện thoại' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-2">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Thẻ xe' &&  m.getCategory_name() == 'Found' or m.getItem_type() == 'Thẻ sinh viên' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-3">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'CMND' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-4">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Bình nước' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-5">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Linh kiện điện tử' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-6">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Ví/bóp' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-7">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Chìa khóa' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
                ...
                <div class="tab-pane container " id="item-pills-tabs-8">
                    <div class="row row-cols-1 row-cols-md-3 g-4 ">
                        <c:forEach items="${list}" var="m">
                            <c:if test="${m.getItem_type() == 'Khác' &&  m.getCategory_name() == 'Found'}">
                                <div class="col mb-4 cards" data-toggle="modal" data-target="#DetailModal${m.getItem_id()}">
                                    <div class="card shadow h-100 card-detail">
                                        <!-- Image -->
                                        <img src="images/${m.getImage()}" class="card-img-top" alt="...">
